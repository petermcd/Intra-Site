...
class Playbook(models.Model):
    ...
    description: models.CharField = models.CharField(
        "description", max_length=2000, unique=False, blank=False, null=False
    )
    playbook: models.TextField = models.TextField(
        "playbook", max_length=10000, unique=False, blank=False, null=False
    )
...
class Application(models.Model):
    ...
    parent: models.ForeignKey = models.ForeignKey(
        "Application", on_delete=models.RESTRICT, null=True, blank=True
    )
    with_playbook: models.ForeignKey = models.ForeignKey(
        Playbook, on_delete=models.RESTRICT, null=True, blank=True
    )
...
class DeviceType(models.Model):
    ...
    image: models.CharField = models.CharField(
        "Image", max_length=50, unique=False, blank=False, null=False
    )
...
class Manufacturer(models.Model):
    ...
    url: models.URLField = models.URLField(
        "URL", max_length=200, unique=True, null=False
    )
...
class Model(models.Model):
    ...
    manufacturer: models.ForeignKey = models.ForeignKey(
        Manufacturer, on_delete=models.RESTRICT, null=False, blank=False
    )
...
class OperatingSystem(models.Model):
    ...
    version: models.CharField = models.CharField(
        "Version", max_length=10, null=False, blank=False
    )
    vendor: models.ForeignKey = models.ForeignKey(
        Vendor, on_delete=models.RESTRICT, null=False, blank=False
    )
    parent: models.ForeignKey = models.ForeignKey(
        "OperatingSystem", on_delete=models.RESTRICT, null=True, blank=True
    )
    with_playbook: models.ForeignKey = models.ForeignKey(
        Playbook, on_delete=models.RESTRICT, null=True, blank=True
    )
    ...
    password: models.CharField = models.CharField(
        "Password", max_length=100, null=True, blank=True
    )
...
class ConnectionType(models.Model):
    ...
    unique_port: models.BooleanField = models.BooleanField(
        "Unique Port", default=True, null=False, blank=False
    )
...
class Device(models.Model):
    ...
    device_type: models.ForeignKey = models.ForeignKey(
        DeviceType, on_delete=models.RESTRICT, null=True, blank=True
    )
    ip: models.GenericIPAddressField = models.GenericIPAddressField(
        "IP Address", unique=True, null=False, blank=False
    )
    mac_address: models.CharField = models.CharField(
        "MAC Address", max_length=48, unique=True, null=True, blank=True
    )
    model: models.ForeignKey = models.ForeignKey(
        Model, on_delete=models.RESTRICT, null=False, blank=False
    )
    operating_system: models.ForeignKey = models.ForeignKey(
        OperatingSystem, on_delete=models.RESTRICT, null=False, blank=False
    )
    connected_via: models.ForeignKey = models.ForeignKey(
        ConnectionType, on_delete=models.RESTRICT, null=False, blank=False
    )
    ...
    port: models.IntegerField = models.IntegerField(
        "Port", default=0, null=False, blank=False
    )
    rack_shelf: models.IntegerField = models.IntegerField(
        "Rack Shelf", null=True, blank=True
    )
    rack_shelf_position: models.IntegerField = models.IntegerField(
        "Rack Shelf Position", null=True, blank=True
    )
    switch_capable: models.BooleanField = models.BooleanField(
        "Switch Capable", default=False, null=False, blank=False
    )
    notes: models.CharField = models.CharField(
        "Notes", max_length=1000, null=False, blank=False
    )
    installed_applications: models.ManyToManyField = models.ManyToManyField(
...
class Domain(models.Model):
    ...
    registrar: models.ForeignKey = models.ForeignKey(
        Registrar, on_delete=models.RESTRICT, null=False, blank=False
    )
...
class Subdomain(models.Model):
    ...
    domain: models.ForeignKey = models.ForeignKey(
        Domain, on_delete=models.RESTRICT, null=False, blank=False
    )
    hosted_on: models.ForeignKey = models.ForeignKey(
        Device, on_delete=models.RESTRICT, null=False, blank=False
    )
...
class Website(models.Model):
    ...
    description: models.CharField = models.CharField(
        "Description", max_length=1000, null=False, blank=False
    )
    secure: models.BooleanField = models.BooleanField(
        "HTTPs", default=True, null=False, blank=False
    )
    subdomain: models.ForeignKey = models.ForeignKey(
        Subdomain, on_delete=models.RESTRICT, null=False, blank=False
    )
    port: models.IntegerField = models.IntegerField(
        "Port", default=443, null=False, blank=False
    )
    path: models.CharField = models.CharField(
        "Path", max_length=1000, default="/", null=False, blank=False
    )
...
def subdomain_delete_dns(sender, instance, **kwargs):
    ...
    auto = Automation()
    auto.delete_dns(
        hostname=instance.__str__(), dns_provider=instance.domain.registrar.name
    )
...
def subdomain_save_dns(sender, instance, **kwargs):
    ...
    if instance.hosted_on_changed():
        ...
        auto.update_dns(
            ...
            ip=instance.hosted_on.ip,
            dns_provider=instance.domain.registrar.name,
        )
